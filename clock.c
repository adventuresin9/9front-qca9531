...
enum {
	...
	Basetickfreq	= 650*Mhz / Cyccntres,	/* ar9531 */
...
clockinit(void)
{
	...
	/* disable atheros clocks */
	*IO(ulong, 0x18060004) = 0x0;
	*IO(ulong, 0x18060098) = 0x0;
	*IO(ulong, 0x180600A0) = 0x0;
	*IO(ulong, 0x180600A8) = 0x0;
